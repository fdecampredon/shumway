...
declare module Shumway.AVM2 {
    ...
    class Analysis {
        ...
        makeBlockSetFactory(length: number, blockById: Map<Bytecode>): void;
...
interface IProtocol {
    ...
    asCallSuper: (scope: any, namespaces: Namespace[], name: any, flags: number, args: any[]) => any;
    asGetSuper: (scope: any, namespaces: Namespace[], name: any, flags: number) => any;
    asSetSuper: (scope: any, namespaces: Namespace[], name: any, flags: number, value: any) => void;
...
declare module Shumway.AVM2.Runtime {
    ...
    function asHasOwnProperty(namespaces: Namespace[], name: any, flags: number): boolean;
    ...
    function asHasTraitProperty(namespaces: Namespace[], name: any, flags: number): boolean;
    ...
    function createFunction(mi: any, scope: any, hasDynamicScope: any, breakpoint: any, useInterpreter?: boolean): any;
    ...
    function applyType(methodInfo: MethodInfo, factory: AS.ASClass, types: any): AS.ASClass;
    function createName(namespaces: Namespace[], name: string, flags: number): Multiname;
}
declare var throwError: (name: any, error: any, ...rest: any[]) => void;
...
declare module Shumway.AVM2.Runtime {
    ...
    class InstanceBindings extends Bindings {
        ...
        scope: any;
        natives: any;
        implementedInterfaces: Map<AS.ASClass>;
...
declare module Shumway.AVM2.AS {
    ...
    class ASClass extends ASObject {
        ...
        classInfo: ClassInfo;
        baseClass: ASClass;
        instanceConstructor: new (...args: any[]) => any;
        instanceConstructorNoInitialize: new (...args: any[]) => any;
        initializer: (...args: any[]) => any;
        defaultInitializerArgument: any;
        classInitializer: (...args: any[]) => any;
        initializers: {
            (...args: any[]): any;
        }[];
        callableConstructor: new (...args: any[]) => any;
        ...
        implementedInterfaces: Map<ASClass>;
        defaultValue: any;
    ...
    class ASFunction extends ASObject {
        ...
        asCall: (self?: any, args?: any) => any;
        asApply: (self?: any, args?: any[]) => any;
        toString(): string;
    }
...
declare module Shumway.AVM2.AS {
    ...
    class Int32Vector extends ASVector<ASInt> {
        ...
        static callable(object: any): Int32Vector;
...
declare module Shumway.AVM2.AS {
    ...
    class Uint32Vector extends ASVector<ASInt> {
        ...
        private _offset;
        constructor(length?: number, fixed?: boolean);
        static callable(object: any): Uint32Vector;
        internalToString(): string;
        toString(): string;
        toLocaleString(): string;
        _view(): Uint32Array;
...
declare module Shumway.AVM2.AS {
    ...
    class Float64Vector extends ASVector<ASInt> {
        ...
        private _offset;
        constructor(length?: number, fixed?: boolean);
        static callable(object: any): Float64Vector;
        internalToString(): string;
        toString(): string;
        toLocaleString(): string;
        _view(): Float64Array;
...
declare module Shumway.AVM2.Compiler.Looper {
    ...
    class BlockSet extends BitSets.Uint32ArrayBitSet {
        blockById: Map<Block>;
        constructor(length: number, blockById: Map<Block>);
...
declare module Shumway.AVM2.Runtime {
    ...
    class AVM2 {
        ...
        notifyConstruct(instanceConstructor: any, args: any): void;
    ...
    class ApplicationDomain {
        ...
        getClass(simpleName: string, strict?: boolean): AS.ASClass;
